...
console.log('Compiling contracts/axiom.compact...');

try {
  const cwd = process.cwd();
  const cmd = `docker run --rm -v "${cwd}:/workspace" -w /workspace midnightnetwork/compactc:latest compactc contracts/axiom.compact managed/`;
